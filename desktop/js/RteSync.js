$('.eqLogicAction[data-action=refreshRte]').on('click', function () {
    $('#div_alert').showAlert({message: 'Synchronisation avec les API RTE..', level: 'warning'});
    $.post({
        url: 'plugins/RteSync/core/ajax/RteSync.ajax.php',
        data: {
            action: 'refreshRte'
        },
