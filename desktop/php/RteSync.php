...
<div class="row row-overflow">
    ...
    <div class="col-xs-12 eqLogicThumbnailDisplay">
        ...
        <div class="eqLogicThumbnailContainer">
            <div class="cursor eqLogicAction logoPrimary" data-action="refreshRte">
        ...
        <legend><i class="fas fa-table"></i> {{Mes API RTE}}</legend>
        ...
        echo '<div class="eqLogicDisplayCard cursor '.$opacity.'" data-eqLogic_id="' . $eqLogic->getId() . '">';
                if (file_exists(dirname(__FILE__) . '/../../desktop/images/' . $eqLogic->getConfiguration('type') . '.png')) {
                    echo '<img src="plugins/RteSync/desktop/images/' . $eqLogic->getConfiguration('type') . '.png' . '" height="105" width="105" />';
                } else {
            ...
            <div role="tabpanel" class="tab-pane active" id="eqlogictab">
                ...
                <form class="form-horizontal">
                    <fieldset>
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label">API RTE</label>
                            <div class="col-sm-3">
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label">ID Secret (base 64)</label>
                            <div class="col-sm-3">
                                <input type="text" class="eqLogicAttr form-control" data-l1key="configuration" data-l2key="authentification" placeholder="ID secret (base 64)"/>
                            </div>
                        </div>
                    </fieldset>
                </form>
...
<?php
include_file('desktop', 'RteSync', 'js', 'RteSync');
